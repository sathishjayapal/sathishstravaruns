package me.sathish.strava.config;
...
import me.sathish.strava.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    ProblemDetail onException(Exception exception) {
        if (exception instanceof ResourceNotFoundException resourceNotFoundException) {
            ...
            problemDetail.setType(URI.create("http://api.sathishstravaruns.com/errors/not-found"));
